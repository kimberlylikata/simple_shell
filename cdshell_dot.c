...
/**
 * cd_dot - func rets to rets to init dir
 * @datash: points to shell vars
 * Return: rets prev dir
 */
...
/**
 * cd_to_home - func changes dir to home
 * @datash: points to home dir
 * Return: rets home dir
 */
